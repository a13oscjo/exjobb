...
$PathtoFile = "$env:HOMEDRIVE\Users\$username\Resources"

if (-not (Test-Path "$env:HOMEDRIVE\Users\$username" -PathType Container))
{
    New-Item "$env:HOMEDRIVE\Users\$username" -itemType directory
}
